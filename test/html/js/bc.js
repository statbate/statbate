...
$(document).on("click", "[data-modal-info]", function(e) {
	...
	$.post("/public/info.php", {'type': type, 'id': id, 'cam': 'bongacams'}, function(json){
...
function bStat() {
    var sock = new WebSocket('wss://statbate.com/bongacams/ws/');
    ...
    sock.onmessage = function(evt) {
        ...
        text = "<a href='/b/"+j.donator+"' rel='nofollow' target='_blank'>"+j.donator+"</a> send "+j.amount+" tokens to <a href='/b/"+j.room+"' rel='nofollow' target='_blank'>"+j.room+"</a>";
        if(j.amount > 499){
