...
<head>
    ...
    <script src="./js/main.js?54"></script>
    <style>
        .x11 {
            opacity: 0.5;
        }
...
<div class="">
    <div class="container">
        <div class="row">
            <div class="col col-lg-10 offset-lg-1 col-xl-10 offset-xl-1">
                ...
                <nav class="navbar navbar-expand-lg navbar-light navbar-light">
                    ...
                    <a class="nav-link d-lg-none trackCount" href="/?list">track <?php echo $track; ?> rooms</a>
                    ...
                    <div class="collapse navbar-collapse" id="navbarNav">
                        ...
                        <ul class="navbar-nav mr-auto mt-2 mt-lg-0">
							...
							<li class="nav-item">
                                <a class="nav-link" href="#">MyFreeCams</a>
                            </li>
                        </ul>
                        <a class="nav-link d-none d-md-inline-block p-0 text-muted trackCount"
                        ...
                        <div class="row d-flex">
                            ...
                            <div class="col-md-5 col-xs-12 order-0 order-md-1 pl-md-1">
                                <table class="table table-curved table-bordered"
                                    ...
                                    <tr height="30">
                                        <td style="padding: 5px 0px;">Average</td>
...
<!--
            <div class="col-6 col-lg-6 offset-lg-1 text-muted">twitter <a href="https://twitter.com/statbate" target="_blank" rel="nofollow" class="text-muted">@statbate</a></div>
            <div class="col-6 col-lg-4 text-right"><a class="text-muted" href="mailto:statbate@gmail.com">statbate@gmail.com</a></div>
-->
        </div>
